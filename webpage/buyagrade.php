...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form action="sucker.php" method="post">
        ...
        else if (isset($_POST['carddetails']))
        {
		...
		<dl>
			...
			<dt>Section</dt>
			<dd>
				<select value="<?= $section ?>" name="section" >
                    <option disabled selected> Choose your section! </option>option>
 					<option>MA</option>
					<option>MB</option>
  					<option>MC</option>
  					<option>MD</option>
			...
			<dt>Credit Card</dt>
			<dd>
				 <input type="text"  name="carddetails"  value="<?= $carddetails ?>" ><br>
				 <label>
